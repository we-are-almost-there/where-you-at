...
describe("SupportRegionMap — 활성 지역 조회", () => {
  ...
  it("꼭짓점이 몰리거나 작은 조각이 복잡해도 알약을 본체의 면적 중심에 둔다", async () => {
    const uneven = {
      type: "MultiPolygon" as const,
      coordinates: [
        [[
          // 본체의 아래쪽 경계만 잘게 나눴다. 좌표 평균은 아래로 쏠리지만 도형은 정사각형이다.
          [126, 34], [127, 34], [128, 34], [129, 34], [130, 34],
          [130, 38], [126, 38], [126, 34],
        ]],
        [[
          // 본체 안의 작은 조각은 꼭짓점 수가 더 많다. 링 길이로 고르면 이쪽에 라벨이 붙는다.
          [126.1, 34.1], [126.2, 34.1], [126.3, 34.1], [126.4, 34.1],
          [126.5, 34.1], [126.5, 34.2], [126.5, 34.3], [126.5, 34.4],
          [126.4, 34.5], [126.3, 34.5], [126.2, 34.5], [126.1, 34.5],
          [126.1, 34.4], [126.1, 34.3], [126.1, 34.2], [126.1, 34.1],
        ]],
      ],
    };
