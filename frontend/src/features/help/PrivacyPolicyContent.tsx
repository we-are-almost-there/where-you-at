    ...
    <div>
      ...
      <LegalSection section={S.destruction} level={level}>
        <Items ordered>
          ...
          <li>
            ...
            직접 삭제합니다. 프로필 사진은 회원이 삭제·교체할 때 기존 파일을 지우며, 회원 탈퇴 시 회원 정보와 함께
            비공개 이미지 저장소에서 삭제합니다. 로그인 세션은 로그아웃하면 현재 세션을 삭제하고, 회원을 탈퇴하면 모든
            세션을 회원 정보와 함께 삭제합니다. 만료된 세션은 같은 회원이 다음에 로그인할 때 삭제합니다. 보유 기간이 지난
            1:1 문의는 데이터베이스의 예약 작업이 매일 자동으로 찾아 파기합니다. 삭제 또는 동의 철회 요청을 확인하거나
            14세 미만 아동의 문의임을 알게 되면, 운영팀은 관련 Slack 알림과 데이터베이스의 문의를 직접 찾아 지체 없이
            삭제합니다. 서버 접속 기록은 각 업체가 정한 로그 보관 기간(4번)에 따라 처리됩니다.
          </li>
          ...
          <li>
            ...
            운영팀이 다시 조회하거나 복원할 수 없게 합니다. 운영팀은 개인정보가 담긴 데이터베이스나 프로필 사진을 따로
            내려받아 백업해 두지 않으며, 종이 문서로도 보관하지 않습니다. 새 문의 알림에 포함된 개인정보는 Slack 메시지를 직접 삭제하며, 별도 요청이 없으면 Slack
      ...
      <LegalSection section={S.overseas} level={level}>
        ...
        <Table
          ...
          rows={[
            ...
            [
              ...
              "싱가포르",
              "회원 정보(카카오 회원번호, 닉네임, 한 줄 소개, 프로필 사진 저장 객체 키), 1:1 문의 정보(이메일, 문의 유형, 문의 내용), 서버 접속 기록(접속 IP 주소, 요청 일시, 요청 주소)",
            ...
            [
              ...
              "회원 정보(카카오 회원번호, 닉네임, 한 줄 소개, 프로필 사진 저장 객체 키, 가입·수정 일시), 1:1 문의 정보(이메일, 문의 유형, 문의 내용, 접수·동의·처리 일시)",
            ...
            [
              ...
              "회원이 직접 올린 프로필 사진과 저장 객체 키",
              "프로필 사진을 등록·변경·조회할 때 암호화된 네트워크를 통해 전송",
              "비공개 프로필 사진 저장·전송과 삭제",
              "프로필 사진 삭제·교체 또는 회원 탈퇴 시까지",
            ],
            [
        ...
        <P>
          ...
          프로필 사진을 올리지 않고 기본 이미지로 이용할 수 있습니다. 다만 웹사이트와 API 서버가 위 업체를 통해 운영되므로
          Vercel·Render로의 이전을 거부하면 서비스를 이용할 수 없습니다.
        </P>
      </LegalSection>
      ...
      <LegalSection section={S.security} level={level}>
        ...
        <Items ordered>
          ...
          <li>
            ...
            검증, 반복 전송 제한, 보유 기간이 지난 개인정보 자동 파기, 암호화된 통신(HTTPS)으로 전송
          </li>
          <li>
      ...
      <LegalSection section={S.rights} level={level}>
        <Items ordered>
          ...
          <li>
            ...
            수 있습니다. 회원 탈퇴로 회원 정보 전체의 삭제를 요구할 수도 있습니다.
          </li>
          <li>
