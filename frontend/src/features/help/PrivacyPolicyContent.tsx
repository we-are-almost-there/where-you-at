 ...
 *   객체를 정리한 뒤 회원 행을 삭제하고, run_record·record_card는 FK 연쇄 삭제한다(README 참고).
      ...
      <LegalSection section={S.purpose} level={level}>
        ...
        <Items ordered>
          <li>
            ...
            줄 소개·프로필 사진 표시와 수정, 완주 기록·기록 카드 모아 보기), 회원 탈퇴 처리
          </li>
          <li>
      ...
      <LegalSection section={S.destruction} level={level}>
        <Items ordered>
          ...
          <li>
            ...
            이미지를 비공개 이미지 저장소에서 삭제하고 완주 기록·기록 카드 정보도 데이터베이스에서 함께 삭제합니다.
      ...
      <LegalSection section={S.outsourcing} level={level}>
        ...
        <Table
          ...
          rows={[
            [
              "Supabase, Inc.",
              "회원 정보, 완주 기록·기록 카드 정보와 1:1 문의 정보를 보관하는 데이터베이스(클라우드) 운영",
            ],
            ["Vercel Inc.", "웹사이트 호스팅 (웹사이트 전송 과정에서 서버 접속 기록 처리)"],
            [
              "Render Services, Inc.",
              "API 서버 운영 (회원 정보, 완주 기록·기록 카드 정보, 1:1 문의 정보, 서버 접속 기록 처리)",
            ],
            [
              "Cloudflare, Inc.",
        ...
        <Table
          ...
          rows={[
            ...
            [
              ...
              "싱가포르",
              "회원 정보(카카오 회원번호, 닉네임, 한 줄 소개, 프로필 사진 저장 객체 키), 완주 기록·기록 카드 정보(코스, 경로 유형, 거리, 소요 시간, 페이스, 완주 시각, 기록 카드 저장 객체 키), 1:1 문의 정보(이메일, 문의 유형, 문의 내용), 서버 접속 기록(접속 IP 주소, 요청 일시, 요청 주소)",
              "서비스를 이용할 때 네트워크를 통해 전송",
              "API 서버 운영",
              "회원 정보, 완주 기록·기록 카드 정보와 1:1 문의 정보는 요청을 처리한 뒤 저장하지 않음. 로그 보관 기간 7일 (Hobby 요금제 기준)",
            ],
            [
              ...
              "회원 정보(카카오 회원번호, 닉네임, 한 줄 소개, 프로필 사진 저장 객체 키, 가입·수정 일시), 완주 기록·기록 카드 정보(코스, 경로 유형, 거리, 소요 시간, 페이스, 완주 시각, 기록 카드 저장 객체 키), 1:1 문의 정보(이메일, 문의 유형, 문의 내용, 접수·동의·처리 일시)",
              "데이터베이스 운영과 장애 대응 등 기술 지원이 필요할 때 원격으로 접근",
              "데이터베이스(클라우드) 운영과 기술 지원",
              "회원 정보와 완주 기록·기록 카드 정보는 회원 탈퇴 시까지, 1:1 문의는 문의 처리 완료 후 1년 (4번과 같음)",
            ],
            [
      ...
      <LegalSection section={S.rights} level={level}>
        <Items ordered>
          ...
          <li>
            ...
            수 있고, 완주 기록과 기록 카드를 확인할 수 있습니다. 회원 탈퇴로 회원 정보와 마이페이지에 저장한 기록 전체의
            삭제를 요구할 수도 있습니다.
          </li>
          <li>
