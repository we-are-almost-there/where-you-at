        ...
        <Table
          ...
          rows={[
            [
              ...
              "회원 탈퇴 시까지(카카오에서 서비스와의 연결을 끊은 경우 포함). 탈퇴하면 지체 없이 파기합니다. 한 줄 소개는 이용자가 지우면 바로 삭제하고, 프로필 사진은 삭제하거나 새 사진으로 바꾸면 기존 파일과 저장 객체 키를 바로 삭제합니다. 완료되지 않은 임시 업로드 파일은 1일 뒤 자동 삭제합니다.",
            ],
            [
      ...
      <LegalSection section={S.destruction} level={level}>
        <Items ordered>
          ...
          <li>
            ...
            비공개 이미지 저장소에서 삭제합니다. 완료되지 않은 임시 업로드 파일은 수명 주기 규칙에 따라 1일 뒤
            삭제합니다. 로그인 세션은 로그아웃하면 현재 세션을 삭제하고, 회원을 탈퇴하면 모든 세션을 회원 정보와 함께
        ...
        <Table
          ...
          rows={[
            ...
            [
              ...
              "프로필 사진 삭제·교체 또는 회원 탈퇴 시까지. 완료되지 않은 임시 업로드 파일은 1일",
            ],
            [
