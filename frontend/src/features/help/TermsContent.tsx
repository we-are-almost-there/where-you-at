 ...
 * 가입·탈퇴와 프로필(닉네임·한 줄 소개·프로필 사진)은 조의2·조의3으로 덧붙였다. 뒤 조항 번호를 밀면 다른 문서·주석의 조항
    ...
    <div>
      ...
      <LegalSection section={S.services}>
        ...
        <Items ordered>
          ...
          <li>
            <strong>마이페이지</strong>: 회원의 프로필(닉네임·한 줄 소개·프로필 사진) 관리, 찜한 코스·완주 기록·기록
            카드·지역 스탬프 모아 보기. 지역 스탬프는 완주한 코스의 출발지 기준 대표 시군구에서 회원이 직접 찍으며, 같은 시군구에는 한 번만 저장됩니다.
          </li>
          <li>
      ...
      <LegalSection section={S.membership}>
        <Items ordered>
          ...
          <li>
            회원은 마이페이지에서 언제든지 탈퇴할 수 있습니다. 탈퇴하면 카카오 계정과의 연결이 해제되고 프로필 사진을
            포함한 회원 정보와 마이페이지에 모인 기록이 삭제되며, 삭제한 정보는 되돌릴 수 없습니다.
          </li>
          <li>
      ...
      <LegalSection section={S.profile}>
        <Items ordered>
          <li>
            회원은 마이페이지에서 닉네임과 한 줄 소개를 정하고 바꿀 수 있으며, 프로필 사진을 등록·변경·삭제할 수 있습니다.
            한 줄 소개와 프로필 사진은 선택 항목이며, 쪽지·리뷰 등 앞으로 추가되는 기능에서 다른 이용자에게 보일 수 있습니다.
          </li>
          <li>
            회원은 자신이 사용할 권리가 있는 사진만 올려야 하며, 닉네임·한 줄 소개·프로필 사진에 다음 내용을 사용해서는 안
            됩니다: 다른 사람의 개인정보나 다른 사람을 사칭하는 내용, 다른 사람의 초상권·저작권·명예 등 권리를 침해하는
            내용, 욕설·음란·혐오 표현, 광고, 그 밖에 관계 법령을 위반하는 내용.
          </li>
          <li>
            운영팀은 제2항에 해당하는 닉네임·한 줄 소개·프로필 사진을 알게 되면 회원에게 알리고 수정을 요청하거나, 해당
            내용을 지우고 기본값으로 바꿀 수 있습니다.
          </li>
        </Items>
      </LegalSection>
