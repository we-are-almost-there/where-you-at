...
새 문의 알림은 아직 없습니다. Slack 알림은 개인정보처리방침 7·8번에 수탁자를 추가하는 후속 PR에서 붙입니다.
그 전까지 확인 당번이 **매주 월요일·목요일** Supabase 테이블 편집기에서 `inquiry` 테이블의 `status = '접수'`인 문의를 확인합니다.

- 개인정보처리방침 11번은 권리 행사(열람·삭제 등) 요청에 10일 이내 회신을 약속합니다. 확인한 문의는 늦어도 다음 확인일 전까지 답장합니다.
